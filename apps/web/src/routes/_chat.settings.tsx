...
function SettingsRouteView() {
  ...
  const [openInstallProviders, setOpenInstallProviders] = useState<Record<ProviderKind, boolean>>({
    ...
    antigravity:
      settingsProviderTarget === "antigravity" || Boolean(settings.antigravityBinaryPath),
    grok: settingsProviderTarget === "grok" || Boolean(settings.grokBinaryPath),
    droid: settingsProviderTarget === "droid" || Boolean(settings.droidBinaryPath),
    kilo:
        ...
        provider === "codex"
          ...
          : provider === "claudeAgent"
            ...
            : provider === "cursor"
              ...
              : provider === "antigravity"
                ? { binaryPath: settings.antigravityBinaryPath }
                : provider === "grok"
                  ? { binaryPath: settings.grokBinaryPath }
                  : provider === "droid"
                    ? { binaryPath: settings.droidBinaryPath }
                  : provider === "kilo"
                    ? {
