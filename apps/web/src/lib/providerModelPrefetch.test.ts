  ...
  it("matches ChatView cache keys for cwd-scoped and binary-scoped providers", () => {
    ...
    expect(cursorOptions.queryKey).toEqual(
      providerDiscoveryQueryKeys.models(
        "cursor", null, "/bin/agent", null, null, null, "https://api.example",
    ...
    expect(openCodeOptions.queryKey).toEqual(
      providerDiscoveryQueryKeys.models(
        "opencode", null, "/bin/opencode", null, null, null, null,
        null, null, null, null, "/tmp/project",
      ),
    );
    ...
    expect(piOptions.queryKey).toEqual(
      providerDiscoveryQueryKeys.models(
        "pi", null, "/bin/pi", null, null, null, null,
        null, null, null, "/tmp/pi-agent", "/tmp/project",
      ),
    );
    ...
    expect(antigravityOptions.queryKey).toEqual(
      providerDiscoveryQueryKeys.models(
        "antigravity", null, "/bin/antigravity", null, null, null,
        null, null, null, null, null, "/tmp/project",
      ),
    );
    ...
    expect(codexOptions.queryKey).toEqual(
      providerDiscoveryQueryKeys.models(
        "codex", null, null, null, null, null, null,
        null, null, null, null, null,
      ),
    );
  });
